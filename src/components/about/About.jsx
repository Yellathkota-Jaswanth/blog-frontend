            ...
            <Wrapper>
                ...
                <Text variant="h5">I'm a Full Stack Developer based in India. 
                    ...
                    <Box component="span" style={{ marginLeft: 5 }}>
                        <Link href="https://github.com/Yellathkota-Jaswanth" color="inherit" target="_blank"><GitHub /></Link>
                    </Box>
                </Text>
                <Text variant="h5">
                    Need something built or simply want to have chat? Reach out to me on Email 
                        <Link href="mailto:jaswanthyellathkota@gmail.com?Subject=This is a subject" target="_blank" color="inherit">
                            <Email />
                        </Link>.
                </Text>
            </Wrapper>
